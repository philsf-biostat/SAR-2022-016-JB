...
tab_d1_f1 %>%
  kable(
    ...
    caption = paste("**Tabela 3** Totais de", d1, "e internações em 2021 em cada Área Programática (AP) para idosos", f1)
  )
```
...
tab_d1_f3 %>%
  kable(
    ...
    caption = paste("**Tabela 3** Totais de", d1, "e internações em 2021 em cada Área Programática (AP) para idosos", f3)
  )
```
...
tab_d2_f1 %>%
  kable(
    ...
    caption = paste("**Tabela 3** Totais de", d2, "e internações em 2021 em cada Área Programática (AP) para idosos", f1)
  )
```
...
tab_d2_f3 %>%
  kable(
    ...
    caption = paste("**Tabela 3** Totais de", d2, "e internações em 2021 em cada Área Programática (AP) para idosos", f3)
  )
```
...
tab_dr_f1 %>%
  kable(
    ...
    caption = paste("**Tabela 3** Totais de", dr, "e internações em 2021 em cada Área Programática (AP) para idosos", f1)
  )
```
...
tab_dr_f3 %>%
  kable(
    ...
    caption = paste("**Tabela 3** Totais de", dr, "e internações em 2021 em cada Área Programática (AP) para idosos", f3)
  )
```
