...
A taxa de internações basal do modelo é
0,15,
...
0,139
com 2% de cobertura.
Pode-se realizar os cálculos preditivos análogos para outras combinações de fatores a partir da equação definida pelo modelo (ver Apêndice).
